use crate::{block_pos::BlockPos, chunk_relative::ChunkRelative, constants::CHUNK_SIZE};
use bytemuck::{Pod, Zeroable};
use serde::{Deserialize, Serialize};

#[repr(C)]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Zeroable, Pod, Serialize, Deserialize)]
